/* ============================================================
   mapa-v1.11.js — Contenido del Mapa de Servicios V1.11
   Revisión 10: se agrega el texto de introducción del segmento
   "Vigilancia presencial" (`segments['vigilancia-presencial'].desc`),
   que hasta V1.10 era un placeholder. Texto propuesto por Claude a
   partir de los lineamientos de Martin (verificadores de eventos con
   experiencia, protección de la propiedad, aviso inmediato ante
   alertas) — aprobada la Opción B. Sin otros cambios de contenido.
   Hereda de V1.10: la corrección del Diferencial de "Alarma
   monitoreada + Videovigilancia" en Hogar, Comercio y Consorcios.
   Hereda de V1.9: "Vigilancia presencial" como segmento propio y la
   unificación de Alarma + Videovigilancia en Consorcios.
   ============================================================ */

'use strict';

window.MAPA_VERSIONS = window.MAPA_VERSIONS || {};
window.MAPA_VERSIONS['v1.11'] = {

  id:   'V1.11',
  desc: 'Revisión 10 — se agrega el texto de introducción del segmento "Vigilancia presencial"',
