/* ============================================================
   mapa-v1.8.js — Contenido del Mapa de Servicios V1.8
   Revisión 7/7: en Comercio, se unifican "Protección anti-intrusión"
   y "Videovigilancia" en un solo servicio destacado ("Alarma
   monitoreada + Videovigilancia", mismo nombre/formato que en
   Hogar), primero en el orden, con tarjeta de ancho completo (flag
   `featured`). A diferencia de Hogar, la Facturación NO se
   reescribió con dos modalidades — Comercio sigue siendo solo
   comodato. Además se elimina "Control de accesos" como servicio de
   Comercio. Hereda de V1.7: la unificación de Hogar. Hereda de V1.5:
   en Consorcios y Edificios, "Monitoreo remoto" pasa a llamarse
   "Videovigilancia" y "Control de perímetro" pasa a llamarse
   "Control de accesos"; "Videoverificación" es servicio propio en
   Hogar, Comercio y Consorcios y Edificios.
   ============================================================ */

'use strict';

window.MAPA_VERSIONS = window.MAPA_VERSIONS || {};
window.MAPA_VERSIONS['v1.8'] = {

  id:   'V1.8',
  desc: 'Revisión 7/7 — Alarma monitoreada + Videovigilancia unificadas en Comercio; se elimina Control de accesos de Comercio',
  ...
  segments: {
    ...
    consorcios: {
      ...
      desc: 'Seguridad para consorcios, edificios y depósitos. Vigilancia presencial, videovigilancia y control de accesos para espacios comunes y accesos.',
      fichaBtn: null,
    },
    empresas: {
      icon: 'ti-briefcase',
  ...
  segmentServices: {
    ...
    obras:      ['totem-obra'],
    consorcios: ['vigilancia-consorcios', 'video-consorcios', 'videoverificacion-consorcios', 'accesos-consorcios'],
  ...
  services: {
    'alarma-hogar': {
      ...
      diff:    'Es un servicio de seguridad integral que no depende del usuario: la central detecta, ve y actúa de forma autónoma ante cualquier emergencia, aunque no se pueda ubicar al cliente. Ante una alerta, la central puede ver las imágenes en tiempo real y responder con información concreta, no solo con una notificación.',
      ficha:   'hogar-venta',
      featured: true,
    },
    ...
    'alarma-comercio': {
      ...
      diff:    'Combina detección, monitoreo, video y respuesta en un solo servicio: el registro de aperturas y cierres permite identificar irregularidades y se reporta mensualmente, y ante una alerta la central puede ver las imágenes en tiempo real para confirmar el evento antes de actuar. SP solo accede a las cámaras ante un evento de alarma.',
    ...
    'videoverificacion-consorcios': {
      ...
      billing: 'Incluido en el abono mensual del servicio de Videovigilancia contratado.',
