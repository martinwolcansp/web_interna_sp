/* ============================================================
   mapa-v1.5.js — Contenido del Mapa de Servicios V1.5
   Revisión 4/7: en Consorcios y Edificios, "Monitoreo remoto" pasa a
   llamarse "Videovigilancia" y "Control de perímetro" pasa a llamarse
   "Control de accesos". Además, se separa "Videoverificación" como
   servicio propio (antes era un ítem dentro de "Videovigilancia") en
...
window.MAPA_VERSIONS['v1.5'] = {

  id:   'V1.5',
  desc: 'Revisión 4/7 — Videoverificación como servicio propio; renombres en Consorcios',
  ...
  segmentServices: {
    hogar:      ['alarma-hogar', 'video-hogar', 'videoverificacion-hogar', 'cerco-hogar'],
