/* ============================================================
   mapa-v1.14.js — Contenido del Mapa de Servicios V1.14
   Revisión 13: ajustes de copy en "Alarma monitoreada +
   Videovigilancia" (Hogar, Comercio, Consorcios y Edificios) y
   renombre del título "¿Cómo se cobra?" a "Modalidad de venta"
   (cambio de código genérico en mapa-servicios.js, no de datos).
   Se saca "con acceso a las imágenes ante cualquier evento" del
   ítem de Monitoreo 24/7 en los 3 segmentos, y se simplifica el
   texto de Modalidad de venta de Hogar y Consorcios (se sacan las
   explicaciones de Comodato/Venta directa, quedan solo los 2
   bullets). Comercio no tiene ese bloque de 2 modalidades (es solo
   comodato) así que no aplica ahí. Sin cambios estructurales.
   ============================================================ */

'use strict';

window.MAPA_VERSIONS = window.MAPA_VERSIONS || {};
window.MAPA_VERSIONS['v1.14'] = {

  id:   'V1.14',
  desc: 'Revisión 13 — Alarma monitoreada + Videovigilancia (Hogar/Comercio/Consorcios): se saca "con acceso a las imágenes ante cualquier evento" del ítem de Monitoreo 24/7; Modalidad de venta de Hogar y Consorcios simplificada (sin las aclaraciones de Comodato/Venta directa). Título "¿Cómo se cobra?" renombrado a "Modalidad de venta" en toda la web.',
  ...
  services: {
    'alarma-hogar': {
      ...
      billing: 'Cargo de instalación único + abono mensual único que incluye monitoreo de alarma y videovigilancia.<br><br>Dos modalidades de equipamiento:<ul class="modal__include-list"><li><i class="ti ti-check"></i>Comodato — para kit de instalación básico</li><li><i class="ti ti-check"></i>Venta directa</li></ul>',
