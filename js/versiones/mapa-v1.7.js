/* ============================================================
   mapa-v1.7.js — Contenido del Mapa de Servicios V1.7
   Revisión 6/7: en Hogar, se unifican "Alarma monitoreada" y
   "Videovigilancia" en un solo servicio destacado
   ("Alarma monitoreada + Videovigilancia"), primero en el orden y
   con tarjeta de ancho completo en la grilla (flag `featured`).
   "Videoverificación" y "Cerco eléctrico" quedan como antes, por
   separado. Hereda de V1.5: en Consorcios y Edificios, "Monitoreo
   remoto" pasa a llamarse "Videovigilancia" y "Control de perímetro"
   pasa a llamarse "Control de accesos"; "Videoverificación" es
...
window.MAPA_VERSIONS['v1.7'] = {

  id:   'V1.7',
  desc: 'Revisión 6/7 — Alarma monitoreada + Videovigilancia unificadas como servicio destacado en Hogar',
  ...
  segmentServices: {
    ...
    comercio:   ['alarma-comercio', 'video-comercio', 'videoverificacion-comercio', 'accesos-comercio'],
    obras:      ['totem-obra'],
  ...
  services: {
    ...
    'video-comercio': {
      ...
      tags:    ['Cámaras int./ext.', 'Grabación continua', 'Acceso remoto'],
      includes: [
