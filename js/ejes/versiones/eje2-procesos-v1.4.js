/* ============================================================
   ejes/versiones/eje2-procesos-v1.4.js
   Módulo "Procesos" (Eje 2) — Sector Comunicaciones — V1.4 (04/08/2026)

   Suma sobre v1.3:
   - Resuelto: no se va a trabajar con número de serie para estos
     equipos. Se saca la referencia de todo el proceso (Proceso 2 y
     Proceso 3) y se cierra la contradicción que estaba pendiente de
     confirmar con Gonza.

   Fuente: Eje2_Procesos.docx (actualizado 04/08/2026), del proyecto
...
window.EJE_VERSIONS['eje2-procesos']['v1.4'] = {

  /* ── METADATOS DE VERSIÓN ─────────────────────────────── */
  versionId:   'V1.4',
  versionDesc: 'Resuelto: no se trabaja con número de serie — sacado de todo el proceso',
  ...
  instalacion: {
    pasos: [
      ...
      { title: 'Cierre de la orden de trabajo',            note: 'Firma del cliente, notificación a Administración. No se pide un formulario adicional de datos del cliente: la documentación se genera en dos copias — Instalación archiva una y traslada la otra a Administración.' },
    ...
    puntosCriticos: [
      ...
      'Resuelto: no hace falta un formulario adicional de datos del cliente — el área de Instalación maneja dos copias de la documentación del cliente: archiva una y traslada la otra a Administración.',
      'Resuelto: no se va a trabajar con número de serie para estos equipos — se saca la referencia del cierre de la orden de trabajo y de todo el proceso (queda cerrada la contradicción que estaba pendiente de confirmar con Gonza).',
  ...
  administrativo: {
    pasos: [
      { title: 'Alta del contrato de comodato',   note: 'En el sistema administrativo: equipo, fecha de inicio, condiciones.' },
      ...
      { title: 'Archivo de documentación',         note: 'Recibe de Instalación la copia de la documentación del cliente (Instalación conserva la otra copia archivada).' },
    ],
    puntosCriticos: [
      ...
      'Resuelto: no se va a trabajar con número de serie para estos equipos — se saca la referencia del alta del contrato de comodato y de todo el proceso (queda cerrada la contradicción que estaba pendiente de confirmar con Gonza).',
    ],
  },
  ...
  bloqueantes: [
    ...
    { punto: 'Gestión administrativa del comodato en el sistema (seguimiento de mora, checklist de baja)', proceso: 'Administrativo',        interlocutor: 'Administración' },
  ],
