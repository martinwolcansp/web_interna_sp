/* ============================================================
   ejes/versiones/eje1-unidad-negocio-v1.5.js
   Módulo "Unidad de Negocio" (Eje 1) — Sector Comunicaciones — V1.5 (13/07/2026)

   Suma sobre v1.4:
   - Resuelto: la baja del comunicador Lantrix aplica en todos los
     casos en que el cliente lo tenga instalado, sin excepciones (ya
     no queda como punto a validar — se saca de Pendientes).
   - Nuevo dato: la actualización del organigrama con la nueva
     estructura del Sector Comunicaciones queda a cargo de la
     Gerencia de Procesos, una vez enviada la comunicación formal a
     toda la empresa (Tema 1).
   - Resuelto: el aviso previo de la actualización del abono por IPC
     baja de 30 a 15 días, a notificar por mail (cláusula
     "Actualización del abono", Tema 4). Deja de estar "en revisión".

   Fuente: Eje1_Unidad_de_Negocio.docx (actualizado 13/07/2026), del
...
window.EJE_VERSIONS['eje1-unidad-negocio']['v1.5'] = {

  /* ── METADATOS DE VERSIÓN ─────────────────────────────── */
  versionId:   'V1.5',
  versionDesc: 'Aviso de actualización del abono resuelto en 15 días; organigrama a cargo de Gerencia de Procesos',
  ...
  general: {
    ...
    objetivos: [
      ...
      'Generar un nuevo flujo de ingresos recurrentes a través del abono de comodato, recuperando la inversión en equipos a partir de la 5ª cuota.',
    ...
    mapaTemas: [
      { tema: 'Tema 1 — Estructura y dependencia jerárquica', estado: 'prog', fecha: 'Definido (02/07/2026), pendiente de validación formal del Jefe de Ampliaciones y de la comunicación interna a toda la empresa' },
      { tema: 'Tema 2 — Dotación inicial del sector',          estado: 'ok',   fecha: 'Definido' },
      { tema: 'Tema 3 — Modelo del nuevo abono',                estado: 'ok',   fecha: 'Definido — sin pendientes (abono ABO-16, $66.000/mes, instalación sin cargo; recupero del equipo en la 5ª cuota, abono sigue igual después)' },
      { tema: 'Tema 4 — Contrato de comodato con el cliente',   estado: 'prog', fecha: 'Definido — falta completar el email para el Derecho de Revocación' },
  ...
  estructura: {
    ...
    pendientes: [
      'Comunicar formalmente la creación del sector a toda la empresa (ver "Comunicacion_Creacion_Sector_Comunicaciones.docx"); una vez comunicada, la Gerencia de Procesos actualiza el organigrama.',
  ...
  contrato: {
    ...
    clausulas: [
      ...
      { clausula: 'Propiedad del equipo',     detalle: 'El sistema es propiedad de SP durante toda la vigencia del contrato — no pasa a ser del cliente al alcanzar la cuota 5. Al finalizar el contrato se desinstala y se retira.' },
      ...
      { clausula: 'Actualización del abono',  detalle: 'SP puede actualizar el abono con periodicidad mínima de 3 meses según la variación acumulada del IPC (INDEC), aplicándose en la práctica según la coyuntura. Si el INDEC discontinúa el IPC o modifica sustancialmente su metodología, se aplica automáticamente el índice oficial que lo suceda o, en su defecto, otro similar a acordar entre las partes, sin que esto paralice la actualización. Con 15 días de aviso previo por mail; si el cliente no acepta, puede rescindir sin penalidad dentro de los 10 días de notificado (Art. 10 quáter, Ley 24.240).' },
  ...
  indicadores: {
    ...
    lista: [
      ...
      { nombre: 'Recupero de comodato',                 descripcion: 'Cantidad de equipos que alcanzaron la 5ª cuota de abono (punto de recupero de inversión).' },
  ...
  pendientesResumen: [
    { tema: 'Tema 1 — Estructura y dependencia jerárquica', estado: 'rev', pendiente: 'Comunicar la creación del sector a toda la empresa (luego, la Gerencia de Procesos actualiza el organigrama); detalle de recursos compartidos con Ampliaciones; circuito con Administración', interlocutor: 'Jefe de Ampliaciones / Gerencia de Procesos / Administración' },
    ...
    { tema: 'Tema 3 — Modelo del nuevo abono',                estado: 'ok',  pendiente: 'Sin pendientes — abono ABO-16 (incluye ABO-10 y ABO-11), $66.000/mes, instalación sin cargo; recupero del equipo en la 5ª cuota', interlocutor: '—' },
    { tema: 'Tema 4 — Contrato de comodato con el cliente',   estado: 'rev', pendiente: 'Completar el correo electrónico para el Derecho de Revocación', interlocutor: 'Legal' },
