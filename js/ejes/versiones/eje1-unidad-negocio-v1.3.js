/* ============================================================
   ejes/versiones/eje1-unidad-negocio-v1.3.js
   Módulo "Unidad de Negocio" (Eje 1) — Sector Comunicaciones — V1.3 (08/07/2026)

   Suma sobre v1.2:
   - Corrección: la comunicación interna de la creación del sector a
     toda la empresa todavía NO se envió (v1.2 decía, por error, que
     ya se había comunicado el 02/07/2026). Se deja como pendiente en
     el texto de Tema 1 y se suma a la lista de pendientes del tema y
     al resumen consolidado.
...
window.EJE_VERSIONS['eje1-unidad-negocio']['v1.3'] = {

  /* ── METADATOS DE VERSIÓN ─────────────────────────────── */
  versionId:   'V1.3',
  versionDesc: 'Corrección: comunicación interna de la creación del sector, pendiente',
