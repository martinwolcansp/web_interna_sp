/* ============================================================
   ejes/versiones/eje2-procesos-v1.3.js
   Módulo "Procesos" (Eje 2) — Sector Comunicaciones — V1.3 (03/08/2026)

   Suma sobre v1.2:
   - Resuelto (viene de la Ficha de Producto, Eje 3): no se pide un
     formulario adicional de datos del cliente. El área de Instalación
     maneja dos copias de la documentación del cliente — archiva una y
     traslada la otra a Administración. Se refleja en el paso "Cierre
     de la orden de trabajo" del Proceso 2 y en los puntos críticos
     resueltos.

   Fuente: Eje2_Procesos.docx (actualizado 03/08/2026), del proyecto
...
window.EJE_VERSIONS['eje2-procesos']['v1.3'] = {

  /* ── METADATOS DE VERSIÓN ─────────────────────────────── */
  versionId:   'V1.3',
  versionDesc: 'Resuelto: sin formulario adicional; Instalación maneja 2 copias de documentación (1 a Administración)',
  ...
  instalacion: {
    pasos: [
      ...
      { title: 'Cierre de la orden de trabajo',            note: 'Firma del cliente, registro del número de serie del equipo entregado en comodato [A CONFIRMAR — ver punto crítico], notificación a Administración. No se pide un formulario adicional de datos del cliente: la documentación se genera en dos copias — Instalación archiva una y traslada la otra a Administración.' },
