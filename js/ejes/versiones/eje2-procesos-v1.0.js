/* ============================================================
   ejes/versiones/eje2-procesos-v1.0.js
   Módulo "Procesos" (Eje 2) — Sector Comunicaciones — V1.0 (07/07/2026)

   Tercero de los 3 módulos internos del Sector Comunicaciones, junto
   con Unidad de Negocio (Eje 1) y la Ficha de Producto (Eje 3). Define
   el detalle paso a paso de los procesos comercial, de instalación y
   administrativo del comodato y el abono. El mantenimiento de los
   equipos es responsabilidad de Servicio Técnico y no se incluye acá
   (ver su validación en la Ficha de Producto, pestaña Áreas).

   Coherencia con los otros módulos:
   - La Ficha de Producto (Eje 3, pestaña Procesos) ya no repite este
     detalle: deja solo el resumen "Proceso / Áreas involucradas" y
     remite acá para el paso a paso completo.
   - Los actores de cada proceso son los mismos roles definidos en
     Unidad de Negocio (Eje 1 → Estructura y Roles).

   Fuente: Eje2_Procesos.docx — versión final (actualizado 07/07/2026),
   del proyecto "Implementación Unidad de Negocio Comunicaciones".
   ============================================================ */
...
window.EJE_VERSIONS['eje2-procesos']['v1.0'] = {

  /* ── METADATOS DE VERSIÓN ─────────────────────────────── */
  versionId:   'V1.0',
  versionDesc: 'Comercial, instalación y administrativo definidos',
  ...
  comercial: {
    pasos: [
      ...
      { title: 'Elaboración de la propuesta comercial',  note: 'Equipo en comodato, elementos a agregar y nuevo abono mensual, con el guion y contenido de venta definidos en la Ficha de Producto (Eje 3).' },
    ...
    puntosCriticos: [
      'El monto del nuevo abono todavía no está definido (Unidad de Negocio, Eje 1 → Modelo de Abono); sin esto no se puede armar la propuesta comercial.',
  ...
  instalacion: {
    pasos: [
      ...
      { title: 'Baja del comunicador Lantrix',             note: 'Si el cliente lo tuviera activo. [A DEFINIR con el responsable del área: protocolo para estos casos]' },
    ...
    puntosCriticos: [
      ...
      'Protocolo de baja del comunicador Lantrix cuando el cliente lo tiene instalado: a definir con el responsable del área.',
      'La baja del comunicador Lantrix debe coordinarse con la Central de Monitoreo para no dejar al cliente sin comunicación en ningún momento durante el cambio.',
  ...
  administrativo: {
    pasos: [
      ...
      { title: 'Creación del nuevo concepto de abono', note: 'En el sistema de facturación.' },
  ...
  bloqueantes: [
    { punto: 'Monto del nuevo abono mensual',                                              proceso: 'Comercial (no hay propuesta sin precio)',                    interlocutor: 'Gerencia + Administración' },
    ...
    { punto: 'Protocolo de baja del comunicador Lantrix cuando el cliente lo tiene instalado', proceso: 'Instalación',                                              interlocutor: 'Jefe de Ampliaciones' },
