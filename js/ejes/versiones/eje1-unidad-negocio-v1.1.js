/* ============================================================
   ejes/versiones/eje1-unidad-negocio-v1.1.js
   Módulo "Unidad de Negocio" (Eje 1) — Sector Comunicaciones — V1.1 (08/07/2026)

   Suma sobre v1.0:
   - Tema 3 (Modelo del nuevo abono) cierra sin pendientes: precio,
     composición y código de Netsuite ya definidos.
       · Abono único ABO-16 Abono Mensual de Monitoreo - 4G/Hellgrun/Ajax
         (incluye ABO-10 y ABO-11): incluye monitoreo, comodato del
         equipo y comunicación por chip celular — no es un concepto
         separado.
       · Precio: $66.000 por mes (valor al 8 de julio de 2026).
       · Instalación: sin cargo para el cliente.
   - Mapa de temas del eje: Tema 3 pasa de "prog" a "ok".
...
window.EJE_VERSIONS['eje1-unidad-negocio']['v1.1'] = {

  /* ── METADATOS DE VERSIÓN ─────────────────────────────── */
  versionId:   'V1.1',
  versionDesc: 'Modelo de abono cerrado: precio, instalación y código Netsuite',
