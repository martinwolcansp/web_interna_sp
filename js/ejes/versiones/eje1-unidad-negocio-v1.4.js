/* ============================================================
   ejes/versiones/eje1-unidad-negocio-v1.4.js
   Módulo "Unidad de Negocio" (Eje 1) — Sector Comunicaciones — V1.4 (13/07/2026)

   Suma sobre v1.3:
   - Resuelto por Gerencia: el punto de recupero del equipo se fija en
     la 5ª cuota (antes decía 6ª — corregido en objetivos, modelo de
     abono, cláusula "Propiedad del equipo" e indicador "Recupero de
     comodato"). A partir de esa cuota el abono sigue igual.
   - Resuelto: si el equipo no se restituye en una baja, se cobra a
     precio de lista de los elementos no devueltos (antes decía
     "según factura de compra o tasación de un tercero independiente")
     — corregido en la cláusula "Daño, robo y seguro".
   - Nuevo pendiente en el contrato (Tema 4): la cláusula "Actualización
     del abono" dice periodicidad mínima de 3 meses y aviso previo de
     30 días. En la práctica se actualiza cada 3 meses según la
     coyuntura, y hay una conversación previa con Carmelo sobre avisar
     por mail con 15 días en vez de 30. No se cambia el texto de la
     cláusula todavía — queda pendiente que Gonza lo valide con el
     abogado antes de decidir si se ajusta.
...
window.EJE_VERSIONS['eje1-unidad-negocio']['v1.4'] = {

  /* ── METADATOS DE VERSIÓN ─────────────────────────────── */
  versionId:   'V1.4',
  versionDesc: 'Recupero de equipo en cuota 5; pendiente validar cláusula de aviso del abono',
  ...
  general: {
    ...
    mapaTemas: [
      ...
      { tema: 'Tema 4 — Contrato de comodato con el cliente',   estado: 'prog', fecha: 'Definido — falta completar el email para el Derecho de Revocación y validar con el abogado si se ajusta el aviso de actualización del abono (30 → 15 días)' },
  ...
  estructura: {
    ...
    pendientes: [
      'Comunicar formalmente la creación del sector a toda la empresa (ver "Comunicacion_Creacion_Sector_Comunicaciones.docx").',
  ...
  contrato: {
    ...
    pendientes: [
      ...
      'Validar con el abogado (a cargo de Gonza) si se ajusta la cláusula de actualización del abono: bajar el aviso previo de 30 a 15 días, a notificar por mail.',
    ],
  },
  ...
  pendientesResumen: [
    { tema: 'Tema 1 — Estructura y dependencia jerárquica', estado: 'rev', pendiente: 'Comunicar la creación del sector a toda la empresa; detalle de recursos compartidos con Ampliaciones; validar baja del Lantrix y circuito con Administración', interlocutor: 'Jefe de Ampliaciones / Administración' },
    ...
    { tema: 'Tema 4 — Contrato de comodato con el cliente',   estado: 'rev', pendiente: 'Completar el correo electrónico para el Derecho de Revocación; validar con el abogado si se ajusta el aviso de actualización del abono (30 → 15 días)', interlocutor: 'Legal / Gonza' },
