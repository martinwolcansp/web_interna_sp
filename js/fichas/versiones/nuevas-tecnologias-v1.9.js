/* ============================================================
   fichas/versiones/nuevas-tecnologias-v1.9.js
   Ficha "Nuevas Tecnologías" — Migración a comodato — V1.9 (03/08/2026)

   Suma sobre v1.8:
   - Público objetivo actualizado: el piloto arranca con clientes con
     tecnología FBI (antes decía "clientes con el comunicador Lantrix
     activo").
   - Checklist de lanzamiento: cerrados "Condiciones comerciales",
     "Contrato", "Procesos internos (Comercial / Instalación /
     Administrativo)" y "Validación de Servicio Técnico" (pasan a OK).
     "Requerimientos para el cliente" se cierra en OK: no se pediría un
     formulario adicional. "Material de marketing" sigue pendiente —
     por el momento no estaría disponible.
   - Equipamiento: se suma el detalle técnico real del kit (marca
     Kümmert) — panel GL-K1ultra, sensor GL-MAG, PIR GL-VIERECK,
     gabinete, trafo, batería Key Power 12V 7Ah, BR100 y teclado
     GL-K1PAD. Esto resuelve el modelo de la central y el protocolo de
     comunicación (WiFi + 4G) que estaban pendientes en v1.8. El
     nombre comercial de la central/app/abono sigue siendo Hellgrun —
     Kümmert es la marca del equipamiento técnico instalado.
   - Área Servicio Técnico: valida que está en condiciones de realizar
     el mantenimiento preventivo y correctivo de los equipos (pasa a OK).

   Fuente: Eje3_Ficha_Producto.docx (actualizado 03/08/2026), del
...
window.FICHA_VERSIONS['nuevas-tecnologias']['v1.9'] = {

  /* ── METADATOS DE VERSIÓN (para el selector) ──────────── */
  versionId:   'V1.9',
  versionDesc: 'Checklist: comerciales/contrato/procesos/Serv. Técnico OK. Kit Kümmert detallado. Público: tecnología FBI',
  ...
  general: {
    ...
    infocards: [
      { icon: 'ti-users',         title: 'Cliente objetivo',    body: 'Cartera actual con tecnología obsoleta; se inicia con clientes con tecnología FBI — grupo piloto de aprox. 50 clientes' },
    ...
    checklist: [
      ...
      { label: 'Condiciones comerciales', status: 'ok', fecha: 'Precio ($66.000/mes), instalación (sin cargo), código de abono (ABO-16) y recupero del equipo en la 5ª cuota, definidos y cerrados por Gerencia' },
      { label: 'Requerimientos para el cliente', status: 'ok', fecha: 'No se pediría un formulario adicional para el cliente' },
      { label: 'Terminología', status: 'ok' },
      { label: 'Contrato', status: 'ok' },
      { label: 'Material de marketing', status: 'rev', fecha: 'Pendiente — por el momento no estaría disponible' },
      ...
      { label: 'Procesos internos (Comercial / Instalación / Administrativo)', status: 'ok', fecha: 'Detalle completo en el módulo Procesos, Eje 2' },
      { label: 'Validación de Servicio Técnico', status: 'ok', fecha: 'Validado — ver pestaña Áreas' },
    ],
  },
  ...
  equipamiento: {
    kits: {
      ...
      grupos: [
        {
          label: 'Equipamiento instalado — en comodato (marca Kümmert)',
          filas: [
            ['Panel / central',                                                    '[GL-K1ultra] Kümmert — placa 8 zonas cableadas + 32 inalámbricas, comunicación integrada WiFi + 4G'],
            ['Módulo de comunicación hacia la central de monitoreo',                'Integrado en el panel GL-K1ultra (WiFi + 4G)'],
            ['Sensor magnético inalámbrico (puertas/ventanas)',                     '[GL-MAG] Kümmert Mag inalámbrico'],
            ['Detector de movimiento (PIR) inalámbrico',                           '[GL-VIERECK] Kümmert Pir inalámbrico, con bracket'],
            ['Gabinete',                                                            'Gabinete plástico para Kümmert'],
            ['Transformador',                                                      'Trafo'],
            ['Batería de respaldo',                                                'Key Power 12V 7Ah'],
            ['Accesorio adicional',                                                'BR100 — [PENDIENTE] confirmar función/modelo'],
        ...
        },
        {
          ...
          filas: [
            ['Teclado', '[GL-K1PAD] Teclado Kümmert LCD'],
          ],
        },
        {
  ...
  precios: {
    ...
    notas: [
      { icon: 'ti-info-circle',    color: '#2563eb', text: 'Ajuste del abono: se actualiza según la variación acumulada del IPC (INDEC), con periodicidad mínima de 3 meses y aviso previo de 15 días por mail. Si el INDEC discontinúa el IPC o modifica su metodología, se aplica automáticamente el índice sucesor o, en su defecto, otro similar a acordar entre las partes. Si el cliente no acepta el nuevo precio, puede rescindir sin penalidad dentro de los 10 días de notificado.' },
  ...
  faq: [
    ...
    { q: '¿El abono puede subir con el tiempo?',
      a: 'Sí, se actualiza según la variación acumulada del IPC (INDEC), con una periodicidad mínima de 3 meses. Si el INDEC discontinúa el IPC o modifica su metodología, se aplica automáticamente el índice sucesor o, en su defecto, otro similar a acordar entre las partes. SP avisa con 15 días de anticipación por mail; si el cliente no acepta el nuevo precio, puede rescindir sin penalidad dentro de los 10 días de notificado.' },
  ],
  ...
  areas: [
    ...
    {
      area: 'Servicio Técnico', responsable: '—', comentarios: 'Confirmó que está en condiciones de realizar el mantenimiento preventivo y correctivo de los equipos', estado: 'ok', fecha: '03/08/2026',
      detalle: {
        titulo: 'Servicio Técnico',
        bloques: [
          { tipo: 'texto', texto: 'El mantenimiento preventivo y correctivo de los equipos Hellgrun es responsabilidad de Servicio Técnico, no del Sector Comunicaciones. Servicio Técnico confirmó estar en condiciones de mantener estos equipos — validación cerrada.' },
        ],
      },
    },
  ],
