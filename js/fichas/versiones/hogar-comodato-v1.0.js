/* ============================================================
   fichas/versiones/hogar-comodato-v1.0.js
   Ficha SP Hogar Seguro (Comodato) — Versión 1.0 · Skeleton
   ============================================================ */

'use strict';

window.FICHA_VERSIONS = window.FICHA_VERSIONS || {};
window.FICHA_VERSIONS['hogar-comodato'] = window.FICHA_VERSIONS['hogar-comodato'] || {};
window.FICHA_VERSIONS['hogar-comodato']['v1.0'] = {

  /* ── METADATOS DE VERSIÓN (para el selector) ──────────── */
  versionId:   'V1.0',
  versionDesc: 'En desarrollo',

  /* ── IDENTIFICACIÓN ───────────────────────────────────── */
  id:      'hogar-comodato',
  badge:   'Hogar',
  name:    'SP Hogar Seguro — Comodato',
  version: '—',
  date:    '—',
  author:  '—',
  ...
  general: {
    ...
    comercializacion: [
      ...
      '— Completar resto de condiciones —',
    ],
    checklist: [
  ...
  precios: {
    cards: [
      ...
      { label: 'Cargo de instalación',   value: '$ —', sub: '— Completar condiciones de bonificación —', featured: false },
    ],
    ...
    notas: [
      { icon: 'ti-info-circle', color: null, text: '— Completar notas sobre precios de comodato —' },
    ],
  },
  ...
  proceso: {
    secciones: [
      {
        label: 'Ventas',
        pasos: [{ title: '— Completar proceso de ventas —', note: '' }],
      },
      {
        label: 'Instalaciones',
        pasos: [{ title: '— Completar proceso de instalaciones —', note: '' }],
      },
    ],
    netsuite: [
