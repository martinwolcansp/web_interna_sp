/* ============================================================
   fichas/versiones/nuevas-tecnologias-v1.8.js
   Ficha "Nuevas Tecnologías" — Migración a comodato — V1.8 (13/07/2026)

   Suma sobre v1.7:
   - Resuelto: el aviso previo de la actualización del abono por IPC
     baja de 30 a 15 días, a notificar por mail. Deja de estar "en
     revisión" (ya no depende de la validación de Gonza con el
     abogado). Se traslada a: pestaña Precios (nota de ajuste del
     abono), FAQ ("¿el abono puede subir con el tiempo?") y pestaña
     Áreas → Legal.
...
window.FICHA_VERSIONS['nuevas-tecnologias']['v1.8'] = {

  /* ── METADATOS DE VERSIÓN (para el selector) ──────────── */
  versionId:   'V1.8',
  versionDesc: 'Aviso de actualización del abono resuelto: 15 días por mail',
