/* ============================================================
   fichas/versiones/nuevas-tecnologias-v1.3.js
   Ficha "Nuevas Tecnologías" — Migración a comodato — V1.3 (08/07/2026)

   Suma sobre v1.2:
   - Condiciones comerciales: precio del abono, costo de instalación
     y código de Netsuite ya definidos por Gerencia + Administración
     (Eje1_Unidad_de_Negocio.docx y Eje2_Procesos.docx, Tema/Proceso 3):
       · Precio del abono mensual: $66.000 (valor al 8 de julio de 2026).
       · Costo de instalación: sin cargo para el cliente.
       · Código de Netsuite: ABO-16 Abono Mensual de Monitoreo -
         4G/Hellgrun/Ajax (incluye ABO-10 y ABO-11) — abono único que
         incluye monitoreo, comodato del equipo y comunicación por
         chip celular.
   - Checklist de lanzamiento: "Condiciones comerciales" pasa a
     "En progreso" con detalle actualizado — ya no falta el precio,
     solo los descuentos de bonificación del Técnico Comercial y el
     análisis de competencia (ambos a cargo de Gerencia).
   - Pestaña Áreas → Gerencia: se saca de su lista de pendientes la
     definición del precio del abono (ya resuelta); se mantienen los
     pendientes de descuentos y de qué pasa con el abono después de
     la cuota de recupero.
   - Sigue pendiente (sin cambios respecto de v1.2): datos técnicos
     del equipo (proveedor Hellgrun), link externo al contrato,
     descuentos de bonificación, análisis de competencia y validación
     de Servicio Técnico.

   Fuente: Eje1_Unidad_de_Negocio.docx, Eje2_Procesos.docx,
   Eje3_Ficha_Producto.docx y Proyecto_Sector_Comunicaciones.docx
...
window.FICHA_VERSIONS['nuevas-tecnologias']['v1.3'] = {

  /* ── METADATOS DE VERSIÓN (para el selector) ──────────── */
  versionId:   'V1.3',
  versionDesc: 'Precio, instalación y código de abono definidos',
