/* ============================================================
   fichas/versiones/hogar-venta-v1.0.js
   Ficha SP Hogar Seguro (Venta) — Versión 1.0 · Skeleton
   ============================================================ */

'use strict';

window.FICHA_VERSIONS = window.FICHA_VERSIONS || {};
window.FICHA_VERSIONS['hogar-venta'] = window.FICHA_VERSIONS['hogar-venta'] || {};
window.FICHA_VERSIONS['hogar-venta']['v1.0'] = {
