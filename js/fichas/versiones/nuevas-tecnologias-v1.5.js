/* ============================================================
   fichas/versiones/nuevas-tecnologias-v1.5.js
   Ficha "Nuevas Tecnologías" — Migración a comodato — V1.5 (08/07/2026)

   Suma sobre v1.4:
   - Contrato revisado (mismo criterio que Eje1_Unidad_de_Negocio.docx,
     Tema 4): se elimina la penalidad por baja anticipada; se agrega
     la obligación de restituir el equipo (o abonar su valor) y la
     conexidad contractual entre comodato y monitoreo.
       · Objeción "¿Y si quiero dar de baja?" actualizada.
       · Infocard "Permanencia" actualizado.
       · Pestaña Precios → "Condiciones de baja anticipada" reemplaza
         la tabla de penalidades por cuota por restitución/valor del
         equipo y conexidad contractual.
       · Pestaña Precios → nota de "Ajuste del abono" suma el índice
         sustituto del IPC si el INDEC lo discontinúa.
       · FAQ "¿El abono puede subir con el tiempo?" alineada con el
         mismo criterio de índice sustituto.
   - Checklist de lanzamiento: ítem "Contrato" suma el pendiente de
     completar el correo electrónico habilitado para el Derecho de
     Revocación (dato en blanco en el contrato original).

   Fuente: Eje1_Unidad_de_Negocio.docx y Eje3_Ficha_Producto.docx
   (actualizados 08/07/2026), del proyecto "Implementación Unidad de
...
window.FICHA_VERSIONS['nuevas-tecnologias']['v1.5'] = {

  /* ── METADATOS DE VERSIÓN (para el selector) ──────────── */
  versionId:   'V1.5',
  versionDesc: 'Contrato revisado: sin penalidad, restitución/valor del equipo',
