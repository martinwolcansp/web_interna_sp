/* ============================================================
   fichas/versiones/nuevas-tecnologias-v1.10.js
   Ficha "Nuevas Tecnologías" — Migración a comodato — V1.10 (04/08/2026)

   Suma sobre v1.9:
   - Resuelto: no se va a trabajar con número de serie para estos
     equipos. Se saca el pendiente "Confirmar con Gonzalo..." de la
     pestaña Áreas → Administración; la definición completa (y su
     baja del proceso) vive en el módulo Procesos, Eje 2.

   Fuente: Eje3_Ficha_Producto.docx (actualizado 04/08/2026), del
...
window.FICHA_VERSIONS['nuevas-tecnologias']['v1.10'] = {

  /* ── METADATOS DE VERSIÓN (para el selector) ──────────── */
  versionId:   'V1.10',
  versionDesc: 'Resuelto: no se trabaja con número de serie — cerrado en Áreas → Administración',
  ...
  areas: [
    ...
    {
      area: 'Administración', responsable: '—', comentarios: 'Circuito de facturación y cobranza definido a nivel de responsabilidades; falta adaptar el sistema de gestión para el nuevo concepto de abono y sus hitos. Resuelto: no se va a trabajar con número de serie para estos equipos', estado: 'rev', fecha: '04/08/2026',
      detalle: {
        titulo: 'Administración',
        bloques: [
          { tipo: 'texto', texto: 'A cargo de la facturación y cobranza del nuevo abono de comodato, a partir de la información que le traslada el Administrativo de Sector Comunicaciones. Definido: no se va a trabajar con número de serie para estos equipos — no corresponde su registro ni seguimiento por ese dato (detalle del cambio en el módulo Procesos, Eje 2).' },
          { tipo: 'lista', items: [
